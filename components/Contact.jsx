              ...
              <div className="lg:p-4 h-full">
                ...
                <div className="">
                  ...
                  <p className="">{fullStack}</p>
                    <p className="text-[10px] mt-2">Contact form is also under Codestruction</p>
                  <p className="py-4">
                ...
                <div className="">
                  ...
                  <div className="flex items-center justify-between py-4">
                    <div className="mt-5 rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-90 ease-in duration-150">
                      <Link
                        href={"https://www.linkedin.com/in/ishanpanchal/"}
                        target="_blank"
                      >
                    ...
                    <div className="mt-5 rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-90 ease-in duration-150">
                      <Link
                        href={"https://www.instagram.com/ishannn___007/"}
                        target="_blank"
                      >
                    ...
                    <div className="mt-5 rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-90 ease-in duration-150">
                      <Link
                        href={"https://github.com/ishan1112"}
                        target="_blank"
                      >
                    ...
                    <div className="mt-5 rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-90 ease-in duration-150">
                      <Link
                        href={"https://twitter.com/AVI2057011"}
                        target="_blank"
                      >
